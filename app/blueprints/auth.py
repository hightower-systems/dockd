...
def _check_csrf():
    ...
    # ALLOWED_ORIGINS env: comma-separated extra origins accepted in
    # addition to the hardcoded LAN allow-list. Trailing slashes are
    # tolerated. Empty (default) preserves LAN-only behavior.
    extra = [
        o.strip().rstrip('/')
